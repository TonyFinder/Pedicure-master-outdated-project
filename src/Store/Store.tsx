...
export const store: StoreType = {
    description: [{
        ...
        ingredients: ['Масло ши и пчелиный воск питают и защищают кожу, обволакивая её защитным эластичным слоем', 'Конский каштан и кофеин улучшают кровообращениеБ выводят токсины и уменьшают отек ног', 'Фктивный ингредиент - кофеин, известный антиоксидант и естественный источник витамина В3'],
